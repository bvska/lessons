...
Занятие 27
1. [Пулы потоков](src/com/ifmo/jjd/multithreading/lesson27)

### Домашнее задание:
1. Изменить сервер из lesson20 так, чтобы выполнение каждой команды было представлено отдельной инструкцией потока. Инструкции передаются на выполнение в пул потоков 
...
3. [Реализация шаблона проектирования](exams/third-exam)
4. [Работа с базами данных с использованием ORM Hibernate](exams/fourth-exam.txt)
